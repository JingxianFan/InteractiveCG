...
public:
  ...
  void DrawProjectedTriangle(V3 *vs, V3 *pvs, V3 *cols, V3 *ns, 
    ...
    FrameBuffer *texture);
  void DrawReflectedMode(TMesh *tm, int tmi, PPC *ppc,cubeMap *cube);
   void DrawReflectedTriangle(V3 *vs, V3 *pvs, V3 *ns, V3 center,
    int tmi, PPC *ppc,cubeMap *cube);
