...
public:
  bool ishw; // flag that is true for fixed pipeline framebuffers
  bool isgpu; // flag that is true for porgr. pipeline framebuffers
  ...
  FrameBuffer* Convolve(float **krn, int n);
